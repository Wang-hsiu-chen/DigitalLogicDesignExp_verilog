...
#push button
set_property PACKAGE_PIN W19 [get_ports {pause_in}]        
...
# all 16 leds
set_property PACKAGE_PIN L1 [get_ports {counter_pause}]
    set_property IOSTANDARD LVCMOS33 [get_ports {counter_pause}]
set_property PACKAGE_PIN P1 [get_ports {counter_reset}]
