...
set_property PACKAGE_PIN T18 [get_ports {tune_do_in}]
    set_property IOSTANDARD LVCMOS33 [get_ports {tune_do_in}]
set_property PACKAGE_PIN W19 [get_ports {tune_re_in}]
    set_property IOSTANDARD LVCMOS33 [get_ports {tune_re_in}]
set_property PACKAGE_PIN U18 [get_ports {tune_mi_in}]
    set_property IOSTANDARD LVCMOS33 [get_ports {tune_mi_in}]
set_property PACKAGE_PIN T17 [get_ports {tune_fa_in}]
    set_property IOSTANDARD LVCMOS33 [get_ports {tune_fa_in}]
set_property PACKAGE_PIN U17 [get_ports {tune_so_in}]
