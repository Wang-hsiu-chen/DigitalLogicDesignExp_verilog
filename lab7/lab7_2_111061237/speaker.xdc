...
set_property PACKAGE_PIN U17 [get_ports {volume_dw_in}] 
set_property IOSTANDARD LVCMOS33 [get_ports {volume_dw_in}] 
set_property PACKAGE_PIN T18 [get_ports {volume_up_in}] 
set_property IOSTANDARD LVCMOS33 [get_ports {volume_up_in}]

set_property PACKAGE_PIN W19 [get_ports {tune_do_in}]
    set_property IOSTANDARD LVCMOS33 [get_ports {tune_do_in}]
set_property PACKAGE_PIN U18 [get_ports {tune_re_in}]
    set_property IOSTANDARD LVCMOS33 [get_ports {tune_re_in}]
set_property PACKAGE_PIN T17 [get_ports {tune_mi_in}]
    set_property IOSTANDARD LVCMOS33 [get_ports {tune_mi_in}]

set_property PACKAGE_PIN L1 [get_ports {tune_do_out}]
    set_property IOSTANDARD LVCMOS33 [get_ports {tune_do_out}]
set_property PACKAGE_PIN P1 [get_ports {tune_re_out}]
    set_property IOSTANDARD LVCMOS33 [get_ports {tune_re_out}]
set_property PACKAGE_PIN N3 [get_ports {tune_mi_out}]
    set_property IOSTANDARD LVCMOS33 [get_ports {tune_mi_out}]
