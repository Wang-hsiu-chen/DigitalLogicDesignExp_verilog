...
set_property PACKAGE_PIN V16 [get_ports {mode_selection}]
set_property IOSTANDARD LVCMOS33 [get_ports {mode_selection}]

set_property PACKAGE_PIN W19 [get_ports {pb_in_l}]
set_property IOSTANDARD LVCMOS33 [get_ports {pb_in_l}]
set_property PACKAGE_PIN U18 [get_ports {pb_in_s}]
set_property IOSTANDARD LVCMOS33 [get_ports {pb_in_s}]
set_property PACKAGE_PIN T17 [get_ports {pb_in_r}]
set_property IOSTANDARD LVCMOS33 [get_ports {pb_in_r}]
